                        ...
                        delegate: ItemDelegate {
                            ...
                            contentItem: ColumnLayout {
                                ...
                                D.Label{
                                    ...
                                    text:qsTr("<a style='text-decoration: none;' href='portal'>Open a browser to authenticate</a>")
                                    onLinkActivated: link =>dccData.exec(NetManager.OpenUrl, model.item.id, {"url": model.item.portalUrl})
                                }
                            }
